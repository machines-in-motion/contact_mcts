...
from contact_mcts.constraints import contact_surface, friction_cone
from contact_mcts.constraints import sliding_friction

def environment_contact(location, orientation, friction_coeff, 
    ...
    if type == 'sticking':
        constr += friction_cone(force, orientation, friction_coeff)
    elif type == 'sliding':
        constr += sliding_friction(force, orientation, friction_coeff, sliding_direction)
    ...
    contact.cost = 1e-1 * cp.sum_squares(contact.force)
