...
from cto.miqp.contacts import miqp_contact, contact_schedule, contact_transition, sticking_contact
    ...
    def setup(self):
        ...
        for _ in range(self.n_modes):
            ...
            for c in range(self.params.n_contacts):
                ...
                env.append(MVar(self.grb_model, (3, self.params.n_envelopes), vtype=GRB.BINARY))
        ...
        # n: time index along the whole trajectory
            ...
            for c in range(self.params.n_contacts):
                ...
                self.constr += sticking_contact(curr_location, 
                                                prev_location, 
                                                prev_surface, 
                                                self.params)
