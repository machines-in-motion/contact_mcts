...
def oriented_jacobian(pin_robot, q, frame_id):
    ...
    body_jacobian = pin.computeFrameJacobian(pin_robot.model, pin_robot.data, q, frame_id)
    Ad = np.zeros((6, 6))
...
def inverse_kinematics_3d(pin_robot, p_des, frame_id, 
                          q_init=None, max_it=100, alpha=0.1, threshold=0.02,
                          q_null=None):
